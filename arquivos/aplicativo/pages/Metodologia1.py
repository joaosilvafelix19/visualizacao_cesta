...
file_url = 'https://github.com/joaosilvafelix19/visualizacao_cesta/raw/main/arquivos/aplicativo/dados/dados_jp.xlsx'

# Importando os dados dos preços não ponderados
@st.cache_data
def load_data(url):
    return pd.read_excel(url, sheet_name="cesta")

# Carregando os dados
try:
    cesta = load_data(file_url)
