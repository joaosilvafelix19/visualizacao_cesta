...
carne = df30['media_carne'].round(2)
leite = df30['media_leite'].round(2)
feijao = df30['media_feijao'].round(2)
arroz = df30['media_arroz'].round(2)
farinha = df30['media_farinha'].round(2)
tomate = df30['media_tomate'].round(2)
pao = df30['media_pao'].round(2)
cafe = df30['media_cafe'].round(2)
banana = df30['media_banana'].round(2)
acucar = df30['media_acucar'].round(2)
oleo = df30['media_oleo'].round(2)
manteiga = df30['media_manteiga'].round(2)
